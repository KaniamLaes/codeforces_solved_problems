...
// int a[N];
void solve(){
    // toroidal neighbours are just adjacent cells and they can be across the grid
    // atleast 3 of them must have same color as the chosen cell

    // blocks of rows/col with same color and size of block >= 2
