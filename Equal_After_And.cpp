...
void solve(){
    ...
    //res will be present in the final array
    //we now need to find the grps that result in the res
    int count=0,total_and=(1<<30)-1;
    rep(i,n){
        total_and&=a[i];
        if(total_and==res) count++,total_and=(1<<30)-1;
    }
    cout<<n-count<<el;
